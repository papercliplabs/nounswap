...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "media" (
  	...
  	"sizes_blog_url" varchar,
  	"sizes_blog_width" numeric,
  	"sizes_blog_height" numeric,
  	"sizes_blog_mime_type" varchar,
  	"sizes_blog_filesize" numeric,
  	"sizes_blog_filename" varchar
  );
  ...
  CREATE INDEX IF NOT EXISTS "media_sizes_blog_sizes_blog_filename_idx" ON "media" USING btree ("sizes_blog_filename");
