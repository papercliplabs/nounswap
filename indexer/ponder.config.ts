  ...
  networks: {
    mainnet: {
      ...
      transport: loadBalance([
        // http(process.env.LOCAL_RPC_URL!),
        rateLimit(http(`https://eth-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY!}`), {
          requestsPerSecond: 12,
        }),
        // rateLimit(http("https://rpc.ankr.com/eth"), { requestsPerSecond: 10 }),
        // rateLimit(http("https://mainnet.gateway.tenderly.co"), { requestsPerSecond: 10 }),
      ]),
    },
    base: {
      chainId: base.id,
      transport: loadBalance([
        ...
        // rateLimit(http(`https://1rpc.io/base`), {
        //   requestsPerSecond: 12,
        // }),
        // rateLimit(http(`https://base.llamarpc.com`), {
        //   requestsPerSecond: 12,
        // }),
        // rateLimit(http(`https://base.gateway.tenderly.co`), {
        //   requestsPerSecond: 12,
        // }),
      ]),
    },
