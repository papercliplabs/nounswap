  ...
  return (
    <section className="flex w-full max-w-[800px] flex-col gap-2 px-6 text-content-secondary md:px-10">
      ...
      <p className="paragraph-sm">
        ...
        We do not endorse any third parties referenced on this site. When you
        invest, your funds are at risk and it is possible that you may lose some
        or all of your investment. Past performance is not a guarantee of future
        results.
      </p>
    </section>
  );
