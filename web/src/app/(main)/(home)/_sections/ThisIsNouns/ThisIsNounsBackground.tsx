...
export function ThisIsNounsBackground({ nouns }: { nouns: Noun[] }) {
  // To fix SSR issues
  ...
  // Avoid rendering randomNouns until they are set
  if (randomNouns.length === 0) return null;

  return (
    <>
      <div className="absolute inset-0 hidden select-none justify-center overflow-hidden md:flex">
      ...
      <div className="relative h-[120px] w-full md:hidden">
        <FloatingNoun
          noun={randomNouns[0]}
