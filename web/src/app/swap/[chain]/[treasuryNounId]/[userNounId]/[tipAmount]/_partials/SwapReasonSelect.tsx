      ...
      <div className="flex grow flex-col items-center justify-between md:pb-[72px]">
        <div className="flex w-full max-w-[1200px] grow flex-col justify-center gap-6 p-4 md:flex-row">
          <div className="flex flex-[2] flex-col gap-4">
            <div className="caption flex w-full flex-row items-center gap-2 rounded-2xl bg-accent-light p-4">
          ...
          <div className="flex h-fit flex-1 flex-col items-center gap-1 rounded-3xl bg-secondary p-1 pt-4">
            <h6 className="pb-2">Review</h6>
            <div className="relative flex w-full flex-col items-center justify-center gap-4 rounded-[20px] bg-primary px-4 pb-8 pt-4 text-secondary">
              You offer
              <div className="flex flex-row items-center justify-center gap-4">
                ...
                <div className="flex h-[100px] items-center justify-center gap-3 rounded-xl bg-secondary px-4 py-2">
                  <h6 className="text-primary">{formatTokenAmount(tip, NATIVE_ASSET_DECIMALS, 6)} WETH</h6>
                </div>
              </div>
              <Icon
                icon="repeat"
                size={52}
                className="absolute bottom-0 right-1/2 translate-x-1/2 translate-y-1/2 rounded-full border-4 border-secondary bg-primary p-3"
              />
            </div>
            <div className="flex w-full flex-col items-center justify-center gap-4 rounded-[20px] bg-primary px-4 pb-4 pt-8 text-secondary">
              For
