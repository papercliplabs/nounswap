...
export default function Modal({ title, isOpen, children, onClose }: ModalProps) {
    ...
    return (
        <>
            ...
            <div
                className={twMerge(
                    "max-w-[90vw] w-[420px] max-h-[60vh] bg-gray-100 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden flex flex-col z-50 rounded-2xl shadow-md",
                    !isOpen && "hidden"
                )}
                ref={ref}
            >
