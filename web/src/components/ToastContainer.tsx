...
export default function ToastContainer() {
  ...
  return (
    <>
      {toasts.map((toast, i) => (
        <div
          className="paragraph-md shadow-overlay bg-background-dark fixed bottom-[24px] left-1/2 z-[100] flex min-w-[min(288px,95vw)] -translate-x-1/2 flex-row items-center gap-3 rounded-xl p-4 text-white"
          key={i}
        >
