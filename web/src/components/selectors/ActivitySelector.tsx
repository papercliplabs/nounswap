...
export const DATA_FOR_ACTIVITY_SELECTOR: Record<ActivitySelector, { name: string }> = {
  all: {
    name: "All",
  },
  swap: {
...
export default function ActivitySelector() {
  ...
  return (
    <Select onValueChange={handleChange}>
      <SelectTrigger className="w-fit">{DATA_FOR_ACTIVITY_SELECTOR[activitySelector].name}</SelectTrigger>
      <SelectContent>
