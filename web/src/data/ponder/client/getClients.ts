...
import { ClientsQuery } from "@/data/generated/ponder/graphql";
import { CHAIN_CONFIG } from "@/config";
import { SECONDS_PER_DAY } from "@/utils/constants";
import { formatEther } from "viem";

const CLIENT_INFO: Record<number, { url: string; icon: string } | undefined> = {
  1: { url: "https://studio.noundry.wtf", icon: "https://studio.noundry.wtf/favicon.ico" },
  ...
  10: { url: "https://nounsagora.com", icon: "https://nounsagora.com/favicon.ico" },
  ...
  15: { url: "https://nouns.auction", icon: "https://nouns.auction/favicon.ico" },
  16: { url: "https://lighthouse.cx", icon: "https://lighthouse.cx/favicon.ico" },
...
export async function getClients(): Promise<Client[]> {
  const data: ClientsQuery = await graphQLFetch(CHAIN_CONFIG.ponderIndexerUrl, query, undefined, {
    next: {
